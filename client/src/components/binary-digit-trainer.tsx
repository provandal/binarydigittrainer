              ...
              <div className="relative h-[550px] bg-gray-50 rounded-lg p-1 overflow-auto">
                <svg className="w-full" viewBox="0 0 750 1300" style={{ minHeight: '1300px' }}>
                  ...
                  <g className="input-layer">
                    <text x="38" y="0" fontSize="20" fill="#666" fontWeight="bold">Input (81)</text>
                    {getPixelValues().map((value, i) => (
                      <g key={`input-${i}`}>
                        ...
                        />
                        <text x="75" y={18 + i * 20} fontSize="7" fill="#000" textAnchor="middle" fontWeight="bold">
                          {value}
                        </text>
                      </g>
                    ))}
                  ...
                  <g className="hidden-layer">
                    <text x="250" y="0" fontSize="20" fill="#666" fontWeight="bold">Hidden (24)</text>
                    {hiddenActivations.map((activation, i) => (
                      <g key={`hidden-${i}`}>
                        ...
                        />
                        <text x="313" y={19 + i * 22} fontSize="8" fill="#000" textAnchor="middle" fontWeight="bold">
                  ...
                  <g className="output-layer">
                    <text x="525" y="0" fontSize="20" fill="#666" fontWeight="bold">Output (2)</text>
                    {outputActivations.map((activation, i) => (
                      <g key={`output-${i}`}>
                        ...
                        />
                        <text x="600" y={67 + i * 120} fontSize="15" fill="#000" textAnchor="middle" fontWeight="bold">
                          {activation.toFixed(2)}
                        </text>
                        <text x="638" y={63 + i * 120} fontSize="15" fill="#666" fontWeight="bold">
